<template>
    <footer class="footer center">
        <div class="footer_main">
            <router-link to="/main" class="footer_main__link">
        ...
        <div class="footer_pages">
            ...
            <router-link to="/main" class="footer_pages__link">Home</router-link>
            <router-link to="/our_projects" class="footer_pages__link">Project</router-link>
            <router-link to="/blog" class="footer_pages__link">Blog</router-link>
        </div>
